...
build() {
    ...
    local cmd=(
        ...
        -DCMAKE_C_FLAGS="-fsanitize=undefined -Wno-error=date-time -Doff64_t=off_t -Dmmap64=mmap -Dlseek64=lseek -static"
        -DCMAKE_CXX_FLAGS="-fsanitize=undefined -Wno-error=date-time -Doff64_t=off_t -Dmmap64=mmap -Dlseek64=lseek -static"
