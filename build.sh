...
build() {
    ...
    local cmd=(
        ...
        -DCMAKE_C_FLAGS="-fsanitize=undefined -DPNG_ARM_NEON_OPT=0 -UPNG_ARM_NEON_IMPLEMENTATION -Wno-error=date-time -Doff64_t=off_t -Dmmap64=mmap -Dlseek64=lseek -Dpread64=pread -Dpwrite64=pwrite -Dftruncate64=ftruncate -DANDROID_HOST_MUSL -static"
        -DCMAKE_CXX_FLAGS="-fsanitize=undefined -DPNG_ARM_NEON_OPT=0 -UPNG_ARM_NEON_IMPLEMENTATION -Wno-error=date-time -Doff64_t=off_t -Dmmap64=mmap -Dlseek64=lseek -Dpread64=pread -Dpwrite64=pwrite -Dftruncate64=ftruncate -DANDROID_HOST_MUSL -static"
